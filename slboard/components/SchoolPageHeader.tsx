...
export function SchoolPageHeader() {
  ...
  return (
    <header className="shrink-0 border-b border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className={`${APP_PAGE_MAX_OUTER_CLASS} py-3 md:py-3.5`}>
        {accessLoading ? (
